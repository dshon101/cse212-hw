...
public class LinkedList : IEnumerable<int>
{
    ...
    public void RemoveTail()
    {
        ...
        // If the list has more than one item, only tail is affected.
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                // If the node is the head, reuse RemoveHead
                if (curr == _head)
                {
                    RemoveHead();
                }
                // If the node is the tail, reuse RemoveTail
                else if (curr == _tail)
                {
                    RemoveTail();
                }
                // Otherwise it's a middle node — reconnect neighbors around it
                else
                {
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            ...
            {
                curr.Data = newValue; // Replace in-place, no relinking needed
            }
            curr = curr.Next; // Keep going — replace ALL matches
        }
    }
